...
struct SettingsView: View {
    ...
    @AppStorage("roadworkdetour_showNotes") private var showNotes: Bool = true
    @AppStorage("roadworkdetour_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/detourlog-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/detourlog-app/terms.html")!)
