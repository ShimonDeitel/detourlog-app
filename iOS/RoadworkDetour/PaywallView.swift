        ...
        ZStack {
            ...
            ScrollView {
                VStack(spacing: 20) {
                    ...
                    Text("Roadwork Detour Pro")
                        .font(Theme.titleFont)
                        .foregroundStyle(Theme.textPrimary)

                    Text("Unlimited detours, route notes, and repeat-route warnings.")
                        .font(Theme.bodyFont)
                    ...
                    Button {
                        ...
                        Group {
                            if purchases.isLoading {
                                ...
                                Text(purchases.product != nil ? "Unlock — \(purchases.product!.displayPrice)" : "Unlock Pro (one-time purchase)")
                            }
                        }
